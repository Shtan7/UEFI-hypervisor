...
namespace hh::x86
{
  enum class cpuid_leaf_functions : uint32_t
  {
    cpuid_version_information = 0x00000001,
    processor_brand_string_0 = 0x80000002,
    processor_brand_string_1 = 0x80000003,
    processor_brand_string_2 = 0x80000004,
  };

  // IPIs are sent with this register
  struct icr
  {
    static constexpr uint32_t icr_offset = 0x300;
